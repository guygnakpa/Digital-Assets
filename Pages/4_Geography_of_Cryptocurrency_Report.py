...
st.set_page_config(page_title=" Digital Assets | Geography of Cryptocurrency Report", layout="wide")
hide_streamlit_nav()
# _____________________________________________________________
...
render_sidebar("Geography of Cryptocurrency Report")
# _____________________________________________________________
...
ChainalysisLogo2 = Image.open("Data_PNG_JPG_Files/Logo0.png")
st.image(ChainalysisLogo2, use_container_width=True)
"\n"

# col11, col22, col33 = st.columns(3)
# with col22:
#     ChainalysisLogo2 = Image.open("Data_PNG_JPG_Files/Logo0.png")
#     st.image(ChainalysisLogo2, use_container_width=500)
#     "\n"
...
st.write("<div style='text-align:justify'> ""\n"
         ...
         "inform the reader about its utilization worldwide through statistical methods, and data visualization.",
         unsafe_allow_html=True)
"\n"
...
df = pd.read_csv("Data_CSV_Files/Geography_Analyst_Data_Assignment.csv")
st.dataframe(df)
st.write("<div style='text-align:justify'> ""\n"
...
SubRegion_TotalTransac_plot0 = px.histogram(df, x="final_sub_region", y=["final_received_usd", "final_deposits"],
                                            title="Sub-Region: Received Funds vs. Deposits | Mar '19 - Apr '22",
                                            width=1360, height=500)
SubRegion_TotalTransac_plot0.update_layout(legend_title="Transaction Type", plot_bgcolor='rgba(0,0,0,0)',
...
Country_TotalTransac_plot0 = px.histogram(df, x="final_country", y=["final_received_usd", "final_deposits"],
                                          title="Country: Received Funds vs. Deposits | Mar '19 - Apr '22",
                                          width=1360, height=700)
Country_TotalTransac_plot0.update_layout(legend_title="Transaction Type", plot_bgcolor='rgba(0,0,0,0)',
                                         xaxis={'categoryorder': 'total descending'})
...
TotalReceived_Top5Regions = A["final_received_usd"] + B["final_received_usd"] + C["final_received_usd"] + D[
    "final_received_usd"] + E["final_received_usd"]
TotalDeposits_Top5Regions = A["final_deposits"] + B["final_deposits"] + C["final_deposits"] + D["final_deposits"] + \
                            E["final_deposits"]
TotalReceived_Top5Regions_USDConversion = babel.numbers.format_currency(float(TotalReceived_Top5Regions), "USD",
                                                                        locale='en_US')
TotalDeposits_Top5Regions_USDConversion = babel.numbers.format_currency(float(TotalDeposits_Top5Regions), "USD",
                                                                        locale='en_US')
...
received_TotalTransac_plot0 = px.histogram(df, x="final_sub_region", y="final_received_usd", color="final_country",
                                           title="Received Funds vs. Sub-Region per Country | Mar '19 - Apr '22",
                                           width=1360, height=500)
received_TotalTransac_plot0.update_layout(legend_title="Country", plot_bgcolor='rgba(0,0,0,0)',
                                          xaxis={'categoryorder': 'total descending'})
...
deposits_TotalTransac_plot0 = px.histogram(df, x="final_sub_region", y="final_deposits", color="final_country",
                                           title="Deposits vs. Sub-Region per Country | Mar '19 - Apr '22",
                                           width=1360, height=500)
deposits_TotalTransac_plot0.update_layout(legend_title="Country", plot_bgcolor='rgba(0,0,0,0)',
...
"\n"
# _____________________insert figure button_______________
PlotB_button = st.expander(
    label="figures 2.0 - 2.A : Sub-region Total Received and Deposits Transactions per country")
PlotB_button.write("""
...
EasternAsia_Received_TotalTransac_plot0 = px.line(Eastern_Asia_Df, x="month_year", y="final_received_usd",
                                                  color="final_country",
                                                  title="Eastern Asia: Monthly Value Received Per Country | Mar '19 - Apr '22",
                                                  width=1360, height=500)
...
EasternAsia_Deposits_TotalTransac_plot0 = px.line(Eastern_Asia_Df, x="month_year", y="final_deposits",
                                                  color="final_country",
                                                  title="Eastern Asia: Monthly Deposits Per Country | Mar '19 - Apr '22",
                                                  width=1360, height=500)
...
NorthAmerica_Received_TotalTransac_plot0 = px.line(Northern_America_Df, x="month_year", y="final_received_usd",
                                                   color="final_country",
                                                   title="North America: Monthly Value Received Per Country | Mar '19 - Apr '22",
                                                   width=1360, height=500)
...
NorthAmerica_Deposits_TotalTransac_plot0 = px.line(Northern_America_Df, x="month_year", y="final_deposits",
                                                   color="final_country",
                                                   title="North America: Monthly Deposits Per Country | Mar '19 - Apr '22",
                                                   width=1360, height=500)
...
st.write("<div style='text-align:justify'> ""\n"
         ...
         "The Republic of Korea, Japan, Taiwon followed the China trend with a much lower volume.",
         unsafe_allow_html=True)
"\n"
# interpredation bodytext
st.write("<div style='text-align:justify'> ""\n"
         ...
         "with a lower volume. Bermuda remained constant with no noticeable improvement in value received.",
         unsafe_allow_html=True)
"\n"
# _____________________insert figure button_______________
PlotC_button = st.expander(
    label="figures 3.0 - 3.A : Eastern Asia and Northern America Monthly Value Received per Country")
PlotC_button.write("""
    Note: Chart is interactive, select country for comparison, Zoom in for low volume data points
...
EasternEurope_Received_TotalTransac_plot0 = px.line(Eastern_Europe_Df, x="month_year", y="final_received_usd",
                                                    color="final_country",
                                                    title="Eastern Europe: Monthly Value Received Per Country | Mar '19 - Apr '22",
                                                    width=1360, height=500)
...
EasternEurope_Deposits_TotalTransac_plot0 = px.line(Eastern_Europe_Df, x="month_year", y="final_deposits",
                                                    color="final_country",
                                                    title="Eastern Europe: Monthly Deposits Per Country | Mar '19 - Apr '22",
                                                    width=1360, height=500)
...
LatinAmerica_Caribbean_Received_TotalTransac_plot0 = px.line(LatinAmerica_Caribbean_Df, x="month_year",
                                                             y="final_received_usd", color="final_country",
                                                             title="Latin America and the Caribbean: Monthly Value Received Per Country | Mar '19 - Apr '22",
                                                             width=1360, height=500)
LatinAmerica_Caribbean_Received_TotalTransac_plot0.update_layout(legend_title="Country",
                                                                 plot_bgcolor='rgba(0,0,0,0)')
LatinAmerica_Caribbean_Received_TotalTransac_plot0.update_yaxes(title="Sum of Received Transactions ($)",
                                                                showgrid=True)
...
LatinAmerica_Caribbean_Deposits_TotalTransac_plot0 = px.line(LatinAmerica_Caribbean_Df, x="month_year",
                                                             y="final_deposits", color="final_country",
                                                             title="Latin America and the Caribbean: Monthly Deposits Per Country | Mar '19 - Apr '22",
                                                             width=1360, height=500)
LatinAmerica_Caribbean_Deposits_TotalTransac_plot0.update_layout(legend_title="Country",
                                                                 plot_bgcolor='rgba(0,0,0,0)')
...
# _________________________________Visulization line charts______________________________________________________________
# WesternEurope_Recieved
WesternEurope_Received_TotalTransac_plot0 = px.line(Western_Europe_Df, x="month_year", y="final_received_usd",
                                                    color="final_country",
                                                    title="Western Europe: Monthly Value Received Per Country | Mar '19 - Apr '22",
                                                    width=1360, height=500)
...
# WesternEurope_Deposits
WesternEurope_Deposits_TotalTransac_plot0 = px.line(Western_Europe_Df, x="month_year", y="final_deposits",
                                                    color="final_country",
                                                    title="Western Europe: Monthly Deposits Per Country | Mar '19 - Apr '22",
                                                    width=1360, height=500)
...
st.write("<div style='text-align:justify'> ""\n"
         ...
         "the countries in the sub-region illustrates a widespread of the total cryptocurrency value deposits",
         unsafe_allow_html=True)
"\n"
"\n"
st.write("<div style='text-align:justify'> ""\n"
...
"\n"
# _____________________insert figure button_______________
PlotD_button = st.expander(
    label="figures 4.0 - 4.A : Latin America and the Caribbean and Western Europe Monthly Deposits per Country")
PlotD_button.write("""
    Note: Chart is interactive, select country for comparison, Zoom in for low volume data points
